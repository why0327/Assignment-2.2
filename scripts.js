...
$(document).ready(function() {
	...
	// Part 1: Click and Hover effects
		...
		$("h1").mouseleave(function() {
			$(this).css("color", "#800080"); // Changes all H1 elements back to their original color ("#FFC107") when the mouse moves back out
		});
	...
	// Part 2: Dynamic content
		...
		$("#more-activities").click(function() {
			...
			for (i=0; i<8; i++) {
				$(".card-container").append('<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3"><div class="card"><img src="assets/img/Nature Education.jpg" class="card-img-top" alt="A picture of a nature education activity." title="A picture of a nature education activity."><div class="card-body"><h5 class="card-title">\Explore nature as an adventurer!</h5><p class="card-text">Some quick example text to build on the card title and make up the bulk of the card\'s content.</p><button class="btn btn-primary">Hide Me</button></div></div>');
			}
